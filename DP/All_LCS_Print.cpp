...
void printAll(int idx1,int idx2, string &s1, string &s2)
{
    if(idx1==n || idx2==m)
    {
        cout<<s<<endl;
    ...
    else
    {
        ...
        {
            printAll(idx1+1,idx2,s1,s2);
        }

	if(val2==dp[idx1][idx2])
        {
            printAll(idx1,idx2+1,s1,s2);
        }
